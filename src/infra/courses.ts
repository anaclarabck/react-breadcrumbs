export const courses = [
  {
    ...
    name: 'Web Front-end',
    modules: [
      { id: 'caa43322-3819-42b9-bcc9-89d8cb71df74', name: 'Móodule 1' },
      { id: '96247b48-2cb4-444a-b753-0f910fd853ec', name: 'Móodule 2' },
      { id: '91f3e010-9ad8-415d-8997-3b611295a1a7', name: 'Móodule 3' },
    ],
  },
  {
